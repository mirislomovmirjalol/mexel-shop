                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6">
                                ...
                                <input placeholder="John" value="{{ $product->name }}" required type="text" name="name"
                                       id="name"
                            ...
                            <div class="col-span-6">
                                ...
                                <textarea rows="3" name="desc" id="desc"
                                          ...
                                          class="py-2.5 px-2.5 mt-1 border border-gray-400 focus:ring-gray-500 focus:border-gray-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">{{ $product->desc }}</textarea>
                            ...
                            <div class="col-span-6">
                                ...
                                <input placeholder="10000" value="{{ $product->price }}" required type="text"
                                       name="price" id="price"
                                       autocomplete="price"
                                       class="py-2.5 px-2.5 mt-1 border border-gray-400 focus:ring-gray-500 focus:border-gray-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                @error('price')
                            ...
                            <div class="col-span-6">
                                ...
                                <input placeholder="10000" value="{{ $product->rate }}" required type="text"
                                       name="rate" id="rate"
                                       autocomplete="rate"
                                       class="py-2.5 px-2.5 mt-1 border border-gray-400 focus:ring-gray-500 focus:border-gray-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                @error('rate')
                                    ...
                                    <div class="space-y-1 text-center">
                                        ...
                                        <div class="flex text-sm text-gray-600">
                                            <label for="image"
                                                ...
                                                <span>Tap here</span>
                                                <input id="image" name="image" type="file" class="sr-only" value="{{ $product->image }}">
                                            </label>
