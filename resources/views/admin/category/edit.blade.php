                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6">
                                ...
                                <input value="{{ $category->name }}" type="text" name="name" id="name" autocomplete="nameCategory"
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6">
                                <span class="block text-sm font-medium text-gray-700 mt-4">Cover</span>
                                <div
                                    ...
                                    <div class="space-y-1 text-center">
                                        ...
                                        <div class="flex text-sm text-gray-600">
                                            <label for="image"
                                                ...
                                                <span>Tap here</span>
                                                <input id="image" name="image" type="file" class="sr-only" value="{{ $category->image }}">
                                            </label>
                                    ...
                                    @enderror
                                    <input type="number" name="id" value="{{ $category->id }}" class="hidden">
                                </div>
                            </div>
                        </div>
